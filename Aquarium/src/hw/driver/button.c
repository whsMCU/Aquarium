...
button_tbl_t button_tbl[BUTTON_MAX_CH] =
{
  ...
  {GPIOB, GPIO_PIN_2, GPIO_PULLUP, GPIO_PIN_RESET},
  {GPIOB, GPIO_PIN_10, GPIO_PULLUP, GPIO_PIN_RESET},
  {GPIOB, GPIO_PIN_12, GPIO_PULLUP, GPIO_PIN_RESET},
  {GPIOB, GPIO_PIN_13, GPIO_PULLUP, GPIO_PIN_RESET},
};
