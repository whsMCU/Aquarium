...
const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
    {
		...
		{GPIOB, GPIO_PIN_7,	 _DEF_OUTPUT,       GPIO_PIN_SET,   GPIO_PIN_RESET, false},		 // 8. CLCD_RS
		{GPIOB, GPIO_PIN_8,	 _DEF_OUTPUT,       GPIO_PIN_SET,   GPIO_PIN_RESET, false},		 // 9. CLCD_EN
		{GPIOB, GPIO_PIN_9,	 _DEF_OUTPUT,       GPIO_PIN_SET,   GPIO_PIN_RESET, false},		 // 10. CLCD_R/W
		{GPIOB, GPIO_PIN_12, _DEF_OUTPUT,       GPIO_PIN_SET,   GPIO_PIN_RESET, false},		 // 11. CLCD_D4
